			...
			foreach (player in level.players)
			{
				if (isdefined(player.guid) && player.guid == xuid)
				{
					...
					if (player.staff == 1)
					{
						...
						player iPrintlnBold("Hello REPZSTAFF! ");
						wait 2;
						player iPrintlnBold("You will receive your rankstatus as soon as you guys fix the lagerror with pending all cmd in console!");
					}
				}
			}
		}
