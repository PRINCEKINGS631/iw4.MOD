...
init()
{
	...
	level.fx[2] = loadfx("smoke/signal_smoke_airdrop");
	level.fx[6] = loadfx( "fire/jet_engine_ac130" );
	level.bombexplosion = loadfx ("explosions/helicopter_explosion_secondary_small");
