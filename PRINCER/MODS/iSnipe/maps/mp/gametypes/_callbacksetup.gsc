...
CodeCallback_PlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, timeOffset)
{
    ...
    if( sMeansOfDeath == "MOD_EXPLOSIVE" && eAttacker == self )
        iDamage = 0;
		

	if(sWeapon == "cheytac_mp" || sWeapon == "svu_mp" || sWeapon == "svu_mp" || sWeapon == "l96a1_mp" || sWeapon == "dsr_mp" || sWeapon == "msr_mp" || sWeapon == "xpr_mp" || sWeapon == level.thermalgun)
    {
	    iDamage = 9001;
		// ITS OVER 9000
	}
