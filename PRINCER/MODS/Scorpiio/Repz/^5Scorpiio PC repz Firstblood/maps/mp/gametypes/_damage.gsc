...
{	
	...
	{
		if (isSubStr(sWeapon, "cheytac_") || isSubStr(sWeapon, "barrett_") || isSubStr(sWeapon, "wa2000_") || isSubStr(sWeapon, "as50_") || isSubStr(sWeapon, "l118a_") || isSubStr(sWeapon, "m21_") || isSubStr(sWeapon, "m40a3_") || isSubStr(sWeapon, "remington700_") || isSubStr(sWeapon, "dragunov_") || isSubStr(sWeapon, "mk14_") || isSubStr(sWeapon, "l96a1_") || isSubStr(sWeapon, "dsr_") || isSubStr(sWeapon, "ballista_") || isSubStr(sWeapon, "fal_") || isSubStr(sWeapon, "mosin_") || isSubStr(sWeapon, "msr_") || isSubStr(sWeapon, "svu_") || isSubStr(sWeapon, "xpr_") || isSubStr(sWeapon, "deserteagle_fmj") || isSubStr(sWeapon, "coltanaconda_fmj") || isSubStr(sWeapon, "concussion_grenade_mp") || isSubStr(sWeapon, "throwingknife_mp") || isSubStr(sWeapon, "frag_grenade_mp") || isSubStr(sWeapon, "semtex_mp") || isSubStr(sWeapon, "claymore_mp") || isSubStr(sWeapon, "c4_mp") || isSubStr(sWeapon, "specialty_tacticalinsertion") || isSubStr(sWeapon, "lynx_") || isSubStr(sWeapon, "default_") )
		{
			switch( sHitLoc )
			{
				case "helmet":
	...
	else if ( getdvar( "dmgt" ) == "5" ) // Hitmarkers
	{
		if (isSubStr(sWeapon, "cheytac_") || isSubStr(sWeapon, "barrett_") || isSubStr(sWeapon, "wa2000_") || isSubStr(sWeapon, "as50_") || isSubStr(sWeapon, "l118a_") || isSubStr(sWeapon, "m21_") || isSubStr(sWeapon, "m40a3_") || isSubStr(sWeapon, "remington700_") || isSubStr(sWeapon, "dragunov_") || isSubStr(sWeapon, "mk14_") || isSubStr(sWeapon, "l96a1_") || isSubStr(sWeapon, "dsr_") || isSubStr(sWeapon, "ballista_") || isSubStr(sWeapon, "fal_") || isSubStr(sWeapon, "mosin_") || isSubStr(sWeapon, "msr_") || isSubStr(sWeapon, "svu_") || isSubStr(sWeapon, "xpr_") || isSubStr(sWeapon, "deserteagle_fmj") || isSubStr(sWeapon, "coltanaconda_fmj") || isSubStr(sWeapon, "concussion_grenade_mp") || isSubStr(sWeapon, "throwingknife_mp") || isSubStr(sWeapon, "frag_grenade_mp") || isSubStr(sWeapon, "semtex_mp") || isSubStr(sWeapon, "claymore_mp") || isSubStr(sWeapon, "c4_mp") || isSubStr(sWeapon, "specialty_tacticalinsertion") || isSubStr(sWeapon, "lynx_") || isSubStr(sWeapon, "default_") )
		{
			switch( sHitLoc )
